            ...
            <div className="flex flex-wrap -mx-4 mb-12 md:mb-20">
              <div className="w-full md:w-1/2 px-4 mb-8">
                <a className="block mb-6 overflow-hidden rounded-md" href="#">
                  <img className="w-full" src="/images/effect.jpg" alt="" />
                </a>
                <div className="mb-4">
                  <a
              ...
              <div className="w-full md:w-1/2 px-4 mb-8">
                <a className="block mb-6 overflow-hidden rounded-md" href="#">
                  <img className="w-full" src="images/work.jpg" alt="" />
                </a>
                <div className="mb-4">
                  <a
                    className="inline-block py-1 px-3 text-xs leading-5 text-emerald-500 hover:text-emerald-600 font-medium uppercase bg-emerald-100 hover:bg-emerald-200 rounded-full shadow-sm"
              ...
              <div className="w-full md:w-1/2 px-4 mb-8">
                <a className="block mb-6 overflow-hidden rounded-md" href="#">
                  <img className="w-full" src="images/work2.jpg" alt="" />
                </a>
                <div className="mb-4">
                  <a
                    className="inline-block py-1 px-3 text-xs leading-5 text-emerald-500 hover:text-emerald-600 font-medium uppercase bg-emerald-100 hover:bg-emerald-200 rounded-full shadow-sm"
              ...
              <div className="w-full md:w-1/2 px-4 mb-8">
                <a className="block mb-6 overflow-hidden rounded-md" href="#">
                  <img className="w-full" src="images/effect2.jpg" alt="" />
                </a>
                <div className="mb-4">
                  <a
                    className="inline-block py-1 px-3 text-xs leading-5 text-emerald-500 hover:text-emerald-600 font-medium uppercase bg-emerald-100 hover:bg-emerald-200 rounded-full shadow-sm"
              ...
              <div className="w-full md:w-1/2 px-4 mb-8 md:mb-0">
                <a className="block mb-6 overflow-hidden rounded-md" href="#">
                  <img className="w-full" src="images/learn.jpg" alt="" />
                </a>
                <div className="mb-4">
                  <a
                    className="inline-block py-1 px-3 text-xs leading-5 text-emerald-500 hover:text-emerald-600 font-medium uppercase bg-emerald-100 hover:bg-emerald-200 rounded-full shadow-sm"
              ...
              <div className="w-full md:w-1/2 px-4">
                <a className="block mb-6 overflow-hidden rounded-md" href="#">
                  <img className="w-full" src="images/macbook.jpg" alt="" />
                </a>
                <div className="mb-4">
                  <a
                    className="inline-block py-1 px-3 text-xs leading-5 text-emerald-500 hover:text-emerald-600 font-medium uppercase bg-emerald-100 hover:bg-emerald-200 rounded-full shadow-sm"
