    ...
    <React.Fragment>
      ...
      <>
        ...
        >
          <div className="container px-4 mx-auto">
            <div className="xl:max-w-4xl mb-12 mx-auto text-center">
              <span className="inline-block py-px px-2 mb-4  leading-5 text-coolGray-300 font-medium uppercase rounded-full shadow-sm">
                HOW IT WORKS
              </span>
              <h1 className="mb-4 text-3xl md:text-4xl leading-tight font-medium font-heading text-white tracking-tighter">
        ...
        >
          <div className="container px-4 mx-auto">
            <div className="md:max-w-5xl mx-auto mb-16 text-center">
              ...
              <p
                className="text-lg  text-coolGray-500 "
                contentEditable="false"
              >
            ...
            <div className="flex flex-wrap justify-center gap-10 -mx-4 px-5 ">
              <div className="flex flex-col gap-4 w-full md:w-[480px] border shadow-lg border-coolGray-100 rounded-md mb-8">
                ...
                <p className="px-8 flex-1 mb-4 text-base md:text-lg text-coolGray-500 ">
                ...
                <div className="px-8 pb-8">
                  <a
                    className="w-fit inline-block py-3 px-5  text-base md:text-lg leading-4 text-emerald-500  text-center bg-white hover:bg-coolGray-100 focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50 border border-emerald-500 rounded-md shadow-sm"
                    href="tel:623-432-1678"
                  >
                    Give us a call
                  </a>
        ...
        <section className="bg-white">
          ...
          <div
            className="py-10 xl:py-24 bg-white"
            // style={{
            //   backgroundImage:
            //     'url("flex-ui-assets/elements/pattern-light-big.svg")',
            //   backgroundPosition: "center",
          ...
          >
            <div className="container px-4 mx-auto">
              <div className="text-center">
                ...
                <h3
                  className="mb-4 text-3xl md:text-5xl text-coolGray-900 font-medium font-heading tracking-tighter"
                  contentEditable="false"
                >
